    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/Anime_Hindi_Official_series")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/Zenith_Cuts455"),
                        InlineKeyboardButton("YouTube Channel", url="https://youtube.com/@zenith_cuts45?si=prHjOR501nAuoUN4")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/Zenith_Cuts455)",
                                     disable_web_page_preview=True)
            return
